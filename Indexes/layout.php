...
img[alt=Batch-File]{
	background-image: url("data:image/gif;base64,R0lGODlhFAAWALMJAH9/f////7+/vwAAAAAAgICAAP//AICAgMDAwP///wAAAAAAAAAAAAAAAAAAAAAAACH5BAEAAAkALAAAAAAUABYAQARpMMlJawUChM37zoOECWRpmkCYjGdLpmLGFcZxDAUHWnzv/zGCcCgMDIxG2Eo2Kxw7u6WmM3jqlNWsdqsFAgHgsHgcDhLPRCWGzAar1p54IArnDAxOqJq5GSAMVnN7U3JXb21tKl6LjAkRADs=");
}
img[alt=binary]{
...
img[alt=Executable-File]{
	background-image: url("data:image/gif;base64,R0lGODlhFAAWAKIFAP///39/f7+/vwAAAAAAgP///wAAAAAAACH5BAEAAAUALAAAAAAUABYAQANVWLrcHSKASeuMQ0HBu/dBVmxfyYVaZK0A5rxwLKdEbdfAkOfoqLIVl08CpAgHyKRymZzNAtCodBql3a63HoTKhYq2RaP2FxaCw60xsaztdkXOuLyQAAA7");
}
img[alt=file]{
...
img[alt=Windows-Installer]{
	background-image: url("data:image/gif;base64,");
}
img[alt=Windows-Registry]{
	background-image: url("data:image/gif;base64,R0lGODlhFAAWAKIHAP///wAAADMzM5mZmQCAgICAgAD//////yH5BAEAAAcALAAAAAAUABYAQAN3KLq89/AIQKutI4c3QQEGARJBYA2bdF0dJUBdYQAkYZdYqmR87wu6laXzirSEpWSJYynYRqQc03MT1UwU1FS40qq4gEnRCA5Xxl9uAMgOlgE9d6VAr3+ychkgYI3ipx8hSn5wbnoEM1dSX0pKF15Hb14PjZWNDwkAOw==");
}
img[alt=word]{
